 ...
 * {@link ChatActivity.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ChatActivity#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ChatActivity extends Fragment {
    Button male,female,transgender;
    String s;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        male=(Button)view.findViewById(R.id.gmale);
        female=(Button)view.findViewById(R.id.gfemale);
        transgender=(Button)view.findViewById(R.id.gtrans);
        male.setTransformationMethod(null);
        female.setTransformationMethod(null);
        transgender.setTransformationMethod(null);
        final AppCompatActivity activity = (AppCompatActivity) view.getContext();
        male.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                s="male";
                Fragment myFragment = new Maritalstatus();
